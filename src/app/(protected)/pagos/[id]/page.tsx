      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8 border-[#969696]/20 shadow-md">
          ...
          <CardContent className="text-[#686363] space-y-2">
            ...
            <p>
              <strong>Importe:</strong> ${pago.importe.toString()}
            </p>

            <p>
              <strong>Medio de Pago:</strong> {pago.medioPago?.nombre}
            </p>

            <p>
              <strong>Estado:</strong> {pago.estadoPago?.nombre}
            </p>
        ...
        <div className="flex gap-4">
          ...
          <Button
            ...
            onClick={() =>
              router.push(`/pagos/editar?id=${pago.id_pago}`)
            }
          >
